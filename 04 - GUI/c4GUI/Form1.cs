...
///Date:        19 Mar 2019
///
///Description: Includes the serializability features of the game, and the
///             event handlers for the drop-piece buttons and the Save-and-
///             Quit button. Also includes helper methods to evaluate the 
///             state of the game after each move and to draw the board
///             
///Variables:   
///
